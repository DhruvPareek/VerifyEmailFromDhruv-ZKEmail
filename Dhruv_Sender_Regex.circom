...
// regex: from:Dhruv Pareek <dhruvpareek883@gmail.com>
template DhruvSenderRegex(msg_bytes) {
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][38] * states[i+2][39];
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][39] * states[i+2][40];
		is_substr0[i][3] <== is_substr0[i][2] + states[i+1][40] * states[i+2][41];
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][41] * states[i+2][42];
		is_substr0[i][5] <== is_substr0[i][4] + states[i+1][42] * states[i+2][43];
		is_substr0[i][6] <== is_substr0[i][5] + states[i+1][43] * states[i+2][44];
		is_substr0[i][7] <== is_substr0[i][6] + states[i+1][1] * states[i+2][2];
		is_substr0[i][8] <== is_substr0[i][7] + states[i+1][44] * states[i+2][1];
		is_substr0[i][9] <== is_substr0[i][8] + states[i+1][3] * states[i+2][4];
		is_substr0[i][10] <== is_substr0[i][9] + states[i+1][2] * states[i+2][3];
		is_substr0[i][11] <== is_substr0[i][10] + states[i+1][4] * states[i+2][5];
		is_substr0[i][12] <== is_substr0[i][11] + states[i+1][5] * states[i+2][6];
		is_substr0[i][13] <== is_substr0[i][12] + states[i+1][6] * states[i+2][7];
		is_substr0[i][14] <== is_substr0[i][13] + states[i+1][8] * states[i+2][9];
		is_substr0[i][15] <== is_substr0[i][14] + states[i+1][7] * states[i+2][8];
		is_substr0[i][16] <== is_substr0[i][15] + states[i+1][10] * states[i+2][11];
		is_substr0[i][17] <== is_substr0[i][16] + states[i+1][9] * states[i+2][10];
		is_substr0[i][18] <== is_substr0[i][17] + states[i+1][11] * states[i+2][12];
		is_substr0[i][19] <== is_substr0[i][18] + states[i+1][12] * states[i+2][13];
		is_substr0[i][20] <== is_substr0[i][19] + states[i+1][13] * states[i+2][14];
		is_substr0[i][21] <== is_substr0[i][20] + states[i+1][15] * states[i+2][16];
		is_substr0[i][22] <== is_substr0[i][21] + states[i+1][14] * states[i+2][15];
		is_substr0[i][23] <== is_substr0[i][22] + states[i+1][16] * states[i+2][17];
		is_substr0[i][24] <== is_substr0[i][23] + states[i+1][17] * states[i+2][18];
